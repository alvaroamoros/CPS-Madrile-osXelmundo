...
edad_intervalos_g + ggsave("edad_intervalos_g.pdf")
...
años_fuera_intervalo_g <- madrileños %>%
  ...
  scale_y_continuous(labels=scales::percent) 
años_fuera_intervalo_g + ggsave("años_fuera_intervalo_g.pdf")
...
nacionalidad_g <- madrileños %>%
  ...
  scale_y_continuous(labels=scales::percent) 
nacionalidad_g +  ylab("") +
  xlab("") + ggsave("nacionalidad_g.pdf")
...
antes_pais_g +  
  ...
  ylab("") +
  xlab("") + ggsave + ggsave("antes_pais_g.dpf")
...
situacion_españa_g +
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("") + ggsave("situacion_españa_g.pdf")
...
#Graficos de barras (%) de todas las dificultades
 ...
 dific_idioma_g <- madrileños %>%
    ...
    scale_y_continuous(labels=scales::percent) 
 dific_idioma_g+ ggsave("dific_idioma_g.pdf")
...
dific_recursos_g +
  ylab("") +
  xlab("")+ ggsave("dific_recursos_g.pdf")
...
dific_idioma_g <- madrileños %>%
  ...
  scale_y_continuous(labels=scales::percent) 
dific_idioma_g +  ylab("") +
  xlab("")+ ggsave("dific_idioma_g.pdf")
...
dific_alojamiento_g +
  ylab("") +
  xlab("")+ ggsave("dific_alojamiento_g.pdf")
...
dific_laborales_g +
  ylab("") +
  xlab("")+ ggsave("dific_laborales_g.pdf")
...
dific_tramites_g +
  ylab("") +
  xlab("")+ ggsave("dific_tramites_g.pdf")
...
dific_sanidad_g <- madrileños %>%
    ...
    geom_bar() +
    theme(legend.position = "none") +
    ggtitle("Dificultades conocimiento questiones sanitarias en el país de destino") +
  scale_y_continuous(labels=scales::percent) 
dific_sanidad_g +
  ylab("") +
  xlab("")+ ggsave("dific_sanidad_g.pdf")
...
dific_integracion_g <- madrileños %>%
    ...
    geom_bar() +
    theme(legend.position = "none") +
    ggtitle("Dificultades para integrarse en la sociedad en el país de destino") + 
  scale_y_continuous(labels=scales::percent) 
dific_integracion_g +
  ylab("") +
  xlab("")+ ggsave("dific_integracion_g.pdf")
...
viajes_madrid_g + theme(legend.position = "none",
                     axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("viajes_madrid_g.pdf")
...
frecuencia_gente_mad_g <- madrileños %>%
  ...
  frecuencia_gente_mad_g + theme(legend.position = "none",
                                 axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("frecuencia_gente_mad_g.pdf")
...
miembro_aso_g <- madrileños %>%
  ...
  xlab("") +
  ylab("")
miembro_aso_g + ggsave("miembro_aso_g.pdf")
...
manifestaciones_g <- madrileños %>%
  ...
  xlab("") +
  ylab("")
manifestaciones_g + ggsave("manifestaciones.pdf")
...
reuniones_g <- madrileños %>%
  ...
  ggtitle("¿Con qué frecuencia se informa sobre la actualidad en España?") +
  scale_y_continuous(labels=scales::percent) +
  xlab("") +
  ylab("")
reuniones_g + ggsave("reuniones_g.pdf")
...
elecciones_generales_esp_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("¿Ha participado en las Elecciones generales de España en noviembre 2019?") + 
  scale_y_continuous(labels=scales::percent) 
elecciones_generales_esp_g + theme(legend.position = "none",
                                      axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("elecciones_generales_esp_g.pdf")
...
elecciones_autonomicas_esp_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("¿Ha participado en las Elecciones autonómicas de Madrid en mayo 2019?") +
  scale_y_continuous(labels=scales::percent) 
elecciones_autonomicas_esp_g  + theme(legend.position = "none",
                                        axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("elecciones_autonomicas_esp_g.pdf")
...
elecciones_municipales_esp_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("¿Ha participado en las Elecciones municipales de España en mayo del 2019?") +
  scale_y_continuous(labels=scales::percent) 
elecciones_municipales_esp_g  + theme(legend.position = "none",
                                      axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("elecciones_municipales_esp_g.pdf")
...
elecciones_municipales_reside_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("¿Ha participado en las Elecciones municipales del país en que reside?") +
  scale_y_continuous(labels=scales::percent)
elecciones_municipales_reside_g +  + theme(legend.position = "none",
                                           axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("elecciones_municipales_reside_g.pdf")
...
elecciones_europeas_españoles_g + theme(legend.position = "none",
                                        axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("elecciones_europeas_españoles_g.pdf")
...
elecciones_europeas_extranjeros_g + theme(legend.position = "none",
                                           axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("elecciones_europeas_extranjeros_g.pdf")
...
conoce_bolsa_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("Conoce la Bolsa de empleo de la Administración Regional madrileña") +
  scale_y_continuous(labels=scales::percent) 
conoce_bolsa_g + theme(legend.position = "none",
                         axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("conoce_bolsa_g.pdf")
...
conoce_ayudas_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("Conoce las ayudas para emprendedores de la Administración Regional madrileña") +
  scale_y_continuous(labels=scales::percent)
conoce_ayudas_g + theme(legend.position = "none",
                       axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("conoce_ayudas_g.pdf")
...
conoce_asociaciones_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("Conoce las asociaciones y centros de madrileños en el extranjero") +
  scale_y_continuous(labels=scales::percent)
conoce_asociaciones_g + theme(legend.position = "none",
                               axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("conoce_asociaciones_g.pdf")
...
conoce_consejo_g + theme(legend.position = "none",
                         axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("conoce_consejo_g.pdf")
...
conoce_portal_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("Conoce el Portal de emigración de la Administración Regional madrileña") +
  scale_y_continuous(labels=scales::percent)
conoce_portal_g + theme(legend.position = "none",
                       axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("conoce_portal_g.pdf")
...
conoce_info_salud_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("Conoce  el servicio de información oficial sobre salud en Madrid") +
  scale_y_continuous(labels=scales::percent)
conoce_info_salud_g + theme(legend.position = "none",
                            axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("conoce_info_salud_g.pdf")
...
conoce_info_padron_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("Conoce el servicio de información oficial sobre el empadronamiento en Madrid") + 
  scale_y_continuous(labels=scales::percent)
conoce_info_padron_g+ ggsave("conoce_info_padron_g.pdf")
...
registrado_consulado_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("¿Se ha registrado en el consulado de la región donde vive?") +
  scale_y_continuous(labels=scales::percent)
registrado_consulado_g + theme(legend.position = "none",
                                 axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("registrado_consulado_g.pdf")
...
motivo_registro_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("¿Por qué ha registrado su residencia en el consulado español?") +
  scale_y_continuous(labels=scales::percent)
motivo_registro_g + theme(legend.position = "none",
                             axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("motivo_registro_g.pdf")
...
motivo_no_registro_g  <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("¿Por qué no ha registrado su residencia en el consulado español?") +
  scale_y_continuous(labels=scales::percent)
motivo_no_registro_g + theme(legend.position = "none",
                             axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("motivo_no_registro_g.pdf")
...
prob_trabajo_g  + theme(legend.position = "none",
                        axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("prob_trabajo_g.pdf")
...
emprender_habilidades_g <- madrileños %>%
  ...
  geom_bar() +
  theme(legend.position = "bottom") +
  ggtitle("En relación con las posibilidades de emprender un negocio, considera 
          que tiene las habilidades y conocimientos necesarios") + 
  scale_y_continuous(labels=scales::percent)
emprender_habilidades_g + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_habilidades_g.pdf")
...
emprender_experiencia_g <- madrileños %>%
  ...
  ggtitle("En relación con las posibilidades de emprender un negocio, 
          considera que tiene experiencia ") + 
  scale_y_continuous(labels=scales::percent)
emprender_experiencia_g + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_experiencia_g.pdf")
...
emprender_conocido_g <- madrileños %>%
  ...
  theme(legend.position = "bottom") +
  ggtitle("En relación con las posibilidades de emprender un negocio, 
          ¿conoce a alguien que ha montado un negocio en los últimos dos años?") + 
  scale_y_continuous(labels=scales::percent)
emprender_conocido_g + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_conocido_g.pdf")
...
emprender_oportunidades_g + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_oportunidades_g.pdf")
...
emprender_fracaso_g + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_fracaso_g.pdf")
...
emprender_idea_g  + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_idea_g.pdf")
...
emprender_capital_g  + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_capital_g.pdf")
...
emprender_impuestos_g  + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_impuestos_g.pdf")
...
emprender_apoyo_g <- madrileños %>%
  ...
  theme(legend.position = "bottom") +
  ggtitle("En relación con las posibilidades de emprender un negocio, 
          ¿considera que falta apoyo o programas públicos, o de las instituciones
          locales en el área donde vive?") + 
  scale_y_continuous(labels=scales::percent)
emprender_apoyo_g  + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_apoyo_g.pdf")
...
emprender_innovador_g <- madrileños %>%
  ...
  theme(legend.position = "bottom") +
  ggtitle("En relación con las posibilidades de emprender un negocio, 
        ¿considera que tiene un proyecto innovador que he aprendido / extraido
        de su experiencia en el exterior?") + 
  scale_y_continuous(labels=scales::percent)
emprender_innovador_g  + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("emprender_innovador_g.pdf")
...
estado_civil_g + theme(legend.position = "none") +
  ylab("") +
  xlab("")+ ggsave("estado_civil_g.pdf")
...
tamaño_municipio_g + theme(legend.position = "none",
                axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("tamaño_municipio_g.pdf")
...
educacion_g <- madrileños %>%
  ...
  scale_y_continuous(labels=scales::percent)
educacion_g+ ggsave("educacion_g.pdf")
...
tipo_contrato_g + theme(legend.position = "none",
                        axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("tipo_contrato_g.pdf")
...
salario_g + theme(legend.position = "none",
                  axis.text.x = element_text(angle = 45, hjust = 1)) +
  ylab("") +
  xlab("")+ ggsave("salario_g.pdf")

# Obtener el directorio temporal de los gráficos
plots.dir.path <- list.files(tempdir(), pattern="rs-graphics", full.names = TRUE); 
plots.pdf.paths <- list.files(plots.dir.path, pattern=".png", full.names = TRUE)

  # Copiar en directorio de destino
  file.copy(from=plots.pdf.paths, to="C:/Users/Petazetas/Desktop/Madrileños por el mundo/")
